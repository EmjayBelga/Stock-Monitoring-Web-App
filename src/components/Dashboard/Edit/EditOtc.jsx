...
const EditOtc = ({ supplies, selectedSupply, setSupplies, setIsEditing, getSupplies }) => {
  ...
  const handleUpdate = async (e) => {
    ...
    // Add a new document in collection "otcSupplies"
    await setDoc(doc(db, "otcSupplies", id), {
      ...supply
    });
